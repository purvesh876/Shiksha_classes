...
//     src="/assets/building.jpg"
//     alt="Shiksha Classes Building"
//     className="w-full max-h-[380px] md:max-h-[420px] object-cover"
//   />
// </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col space-y-16">
          ...
          >
            ...
            {/* LEFT: Building Image - SAME SIZE AS ABOUT US BOX */}
            <div
              className="rounded-3xl p-10 flex flex-col items-center justify-center bg-white/60 backdrop-blur-lg"
              style={{
                border: `1px solid rgba(22,130,135,0.3)`,
                boxShadow: '0 10px 30px rgba(22,130,135,0.25)',
              }}
            >
              <div className="w-full max-w-md mx-auto">
                <img
                  src="/assets/building.jpg"
                  alt="Shiksha Classes Building"
                  className="w-full h-auto rounded-2xl shadow-lg object-contain max-h-[400px]"
                />
              </div>
              <p className="mt-4 text-sm text-center text-[#11616a] font-medium">
                Shiksha Classes, Bhandara
              </p>
            </div>
