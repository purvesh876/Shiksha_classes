    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none -z-10">
        <div
          ...
          style={{
            background:
              'radial-gradient(circle at center, rgba(32,124,151,0.3), rgba(32,124,151,0))',
          }}
        />
        <div
            ...
            return (
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 8px 32px 0 rgba(32,124,151,0.18)',
              ...
              >
                ...
                <div className="flex flex-col justify-between min-h-[420px] rounded-2xl bg-white/80 backdrop-blur-lg shadow-xl p-7 transition-transform duration-300 group-hover:-translate-y-2 group-hover:shadow-2xl">
                  ...
                  <div className="absolute inset-0 rounded-3xl pointer-events-none group-hover:shadow-[0_0_0_6px_rgba(32,124,151,0.15)] transition-all duration-300"></div>
                  {/* Logo */}
                  <div className="flex flex-col items-center">
                    <div
                      className="w-20 h-20 mb-4 rounded-full flex items-center justify-center bg-white shadow-md overflow-hidden"
                      style={{ border: `3px solid ${DEEP_TEAL}` }}
                    >
                      {course.logo ? (
                        <img
                          src={course.logo}
                        ...
                        <span className="text-3xl font-extrabold" style={{ color: DEEP_TEAL }}>
                          {course.title.charAt(0)}
                        </span>
                      )}
                    </div>
                    <h3 className="text-xl font-bold text-center text-[#093f46] mb-1 tracking-tight">
                      {course.title}
                    </h3>
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    <div className="space-y-3 mt-2">
                      {featuresToShow.map((feature, index) => (
                        <div key={index} className="flex items-start space-x-3 text-gray-800 group">
                          <div
                            className="rounded-full p-1.5 flex-shrink-0 bg-gradient-to-br from-[#207C97] to-[#145e74] shadow"
                          >
                    ...
                    {showToggle && (
                      <button
                        ...
                        className="flex items-center mt-4 text-[#207C97] text-sm font-semibold hover:underline focus:outline-none transition-colors"
                      >
                        {isExpanded ? (
                          <>
