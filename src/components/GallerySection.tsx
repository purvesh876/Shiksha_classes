...
//                     className="w-44 h-44 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 bg-gray-200 flex items-center justify-center shadow-xl rounded-full transition-all duration-300 group-hover:scale-110 group-hover:shadow-2xl"
//                     style={{
            ...
            {topRow.map((item, idx) => {
              ...
              return (
                ...
                >
                  <div
                    className="w-44 h-44 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 bg-gray-200 flex items-center justify-center shadow-xl rounded-full transition-all duration-300 group-hover:scale-110 group-hover:shadow-2xl"
                    style={{ border: `4px solid rgba(22,130,135,0.2)` }}
                  >
                    {img ? (
                      <img
                        src={img}
